...
using metroflip.metroflip_XamlTypeInfo;
...
namespace metroflip.metroflip_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_Flip() { return new metroflip.Flip(); }

        private object Activate_1_MainPage() { return new metroflip.MainPage(); }
        ...
        private object get_0_Flip_TextPrev(object instance)
        {
            var that = (metroflip.Flip)instance;
            return that.TextPrev;
        }
        private void set_0_Flip_TextPrev(object instance, object Value)
        {
            var that = (metroflip.Flip)instance;
            that.TextPrev = (System.String)Value;
        }
        private object get_1_Flip_TextNext(object instance)
        {
            var that = (metroflip.Flip)instance;
            return that.TextNext;
        }
        private void set_1_Flip_TextNext(object instance, object Value)
        {
            var that = (metroflip.Flip)instance;
            that.TextNext = (System.String)Value;
        }
